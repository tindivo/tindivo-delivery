...
export const ErrorCodes = {
  ...
  URGENT_NOT_AVAILABLE: 'URGENT_NOT_AVAILABLE',
  DRIVER_NOT_AUTHORIZED_FOR_RESTAURANT: 'DRIVER_NOT_AUTHORIZED_FOR_RESTAURANT',
  ...
  ORDER_ALREADY_TRANSFERRED: 'ORDER_ALREADY_TRANSFERRED',
