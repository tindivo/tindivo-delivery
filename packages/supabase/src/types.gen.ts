  ...
  public: {
    Tables: {
      address_capture_events: {
        Row: {
          accuracy_reported: number | null
          action: string
          created_at: string
          distance_dragged_m: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "address_capture_events_driver_id_fkey"
            columns: ["driver_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "address_capture_events_order_id_fkey"
            columns: ["order_id"]
            isOneToOne: false
