  ...
  toDomain(row: OrderRow): Order {
    ...
    const props: OrderProps = {
      ...
      payment: PaymentIntent.create(
        ...
        row.yape_amount != null ? Money.pen(Number(row.yape_amount)) : null,
        row.cash_amount != null ? Money.pen(Number(row.cash_amount)) : null,
        row.payment_status_at_creation ?? row.payment_status,
