...
const CODE_TO_STATUS: Record<string, number> = {
  ...
  TRANSFER_REQUEST_NOT_FOUND: 404,
  TRANSFER_REQUEST_NOT_PENDING: 409,
  TRANSFER_REQUEST_EXPIRED: 409,
  ORDER_ALREADY_TRANSFERRED: 409,
...
const CODE_TO_TITLE: Record<string, string> = {
  ...
  IDEMPOTENCY_KEY_MISMATCH: 'Idempotency-Key reutilizada con body distinto',
  ...
  TRANSFER_REQUEST_NOT_FOUND: 'Solicitud no encontrada',
  TRANSFER_REQUEST_NOT_PENDING: 'La solicitud ya no está pendiente',
  TRANSFER_REQUEST_EXPIRED: 'La solicitud expiró',
