...
export function RestaurantHistory() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 items-start w-full">
      {/* Columna Izquierda: Filtros y Calendarios */}
      <aside className="w-full md:w-[260px] lg:w-[300px] shrink-0 space-y-5 bg-white/40 p-4 rounded-[24px] border border-[rgba(225,191,181,0.15)] backdrop-blur-md">
        <div>
          <h3 className="text-xs font-black uppercase text-on-surface-variant/85 tracking-wider mb-3 px-1">
            Rango de fechas
          </h3>
              ...
              {PRESETS.map((p) => {
                ...
                return (
                  <button
                    ...
                    className="flex-1 text-[11px] font-bold tracking-wider uppercase px-1.5 py-2.5 rounded-full transition-all duration-300 active:scale-95"
                    style={{
                      background: active
        ...
        {activeTab === 'pedidos' ? (
          <div className="pt-3.5 border-t border-[rgba(225,191,181,0.15)]">
            <h3 className="text-xs font-black uppercase text-on-surface-variant/85 tracking-wider mb-3 px-1">
              Estado del pedido
            </h3>
              ...
              {STATUS_FILTERS.map((f) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'text-[12px] font-bold tracking-wider uppercase px-4 py-2.5 rounded-full transition-all duration-300 active:scale-95 text-left',
                    )}
                    style={{
                      background: active
                        ? 'linear-gradient(135deg, #FF6B35 0%, #FF8C42 100%)'
          ...
          <div className="pt-3.5 border-t border-[rgba(225,191,181,0.15)] space-y-4">
            <h3 className="text-xs font-black uppercase text-on-surface-variant/85 tracking-wider mb-2 px-1">
              Filtros de cliente
            </h3>
            {/* Buscador */}
            <div className="relative w-full">
              <input
                ...
                className="w-full pl-9 pr-8 py-2 text-xs font-semibold rounded-2xl border text-on-surface bg-white/70 border-[rgba(225,191,181,0.4)] focus:outline-none focus:ring-2 focus:ring-primary/30"
              />
              <div className="absolute left-2.5 top-1/2 -translate-y-1/2 flex items-center text-on-surface-variant/60">
              ...
              {custSearch && (
                <button
                  ...
                  className="absolute right-2.5 top-1/2 -translate-y-1/2 flex items-center text-on-surface-variant/60 hover:text-on-surface"
                >
            ...
            <div className="space-y-3">
              <div className="flex flex-col gap-1">
                ...
                <select
                  ...
                  className="w-full rounded-2xl border px-3 py-2 text-xs font-semibold bg-white/70 border-[rgba(225,191,181,0.4)] text-on-surface focus:outline-none"
                >
              ...
              <div className="flex flex-col gap-1">
                ...
                <div className="flex gap-1.5">
                  <select
                    ...
                    className="flex-1 rounded-2xl border px-3 py-2 text-xs font-semibold bg-white/70 border-[rgba(225,191,181,0.4)] text-on-surface focus:outline-none"
                  >
            ...
            <div className="pt-1">
              <label className="flex items-start gap-2 cursor-pointer select-none px-1">
                <input
                  ...
                  className="w-4 h-4 mt-0.5 rounded text-primary focus:ring-primary border-gray-300 transition-colors shrink-0"
                />
                <span className="text-[11px] font-bold text-on-surface-variant/90 leading-tight">
