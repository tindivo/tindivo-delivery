 ...
 * PWA en background; este hook da feedback audible cuando la app ya está
 * abierta.
 *
 * Reusable entre roles: lo usa el driver (`available-orders-list`) cuando
 * un pedido pasa a overdue sin driver, y el restaurante (`active-orders`)
 * cuando uno de SUS pedidos llega a 0 y aún no tiene driver — ambos casos
 * requieren acción inmediata humana.
 *
 * Edge cases:
